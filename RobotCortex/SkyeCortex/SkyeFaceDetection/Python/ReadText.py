...
pathToFileInDisk = r'/home/pi/Documents/SkyeRobotBeta/SkyeCortexBeta/SkyeFaceDetection/Python/text.jpg'
...
for i in range(len(data.get("regions")[0].get("lines"))):
    for j in range(len(data.get("regions")[0].get("lines")[i].get("words"))):
        print(data.get("regions")[0].get("lines")[i].get("words")[j].get("text"))
